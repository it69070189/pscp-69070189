...
รับค่า n บรรทัด
output:
แสดงผล จากการที่คำนวณ n บรรทัด จากการพิม + , -
constraints:
คำนวณได้แค่ + และ -
```
...
```text
ให้ลูป n บรรทัด และให้กรอก + , - แล้วคำนวณแสดงผล
```
...
```text
หากค่าไม่ตรงจะยอดรวม แต่ กำหนดค่าไว้แค่ + , -
```
...
```text
หากค่า n เป็นจำนวนเต็ม 0 จะแสดงยอดรวม
```
