...
รับค่าจำนวนเต็ม N
output:
แสดงจำนวนครั้งที่น้อยที่สุดจาก N ไปถึง 1
constraints:
input > 0 และ หาก N = 1 ให้แสดงผล 0
```
...
```text
หา pattern ในการให้ จาก N ไปถึง 1 ให้น้อยที่สุด และหาเงื่อนไขที่จะทำให้ได้ขั้นตอนน้อยที่สุด
```
...
```text
หาตำแหน่งของ N ให้ตรงกับเงื่อนไขถึงจะลดลงไปเรื่อยๆจนถึง 1 ได้ โดยการกำหนด ว่าหารด้วย 2 ลงตัวหรือไม่
```
...
```text
หาก input = 1 จะแสดงผล 0 โดยไม่ต้องผ่านการคำนวณต่างๆ
```
