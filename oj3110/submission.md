...
```text
input:
รับค่าต้นทาง กับ ปลายทาง และ น้ำหนัก
output:
แสดงผลเงินที่ต้องจ่าย
constraints:
ถ้าไม่อยู่ในปลายทางหรือต้นทางที่กำหนด จะแสดง ERROR
```
...
```text
กำหนดต้นทางปลายทางให้ตรงกัน และจึงบวกค่าธรรมเนียมเข้าไปใน ต้นทางและปลายทางนั้นๆ
```
...
```text
เหมือนกันแผนแรก สร้างกำหนดช่วง กำหนดข้อมูลและตรวจสอบว่าตรงหรือไม่หากตรงให้แสดงผล
```
...
```text
ต้นทางปลายทางไม่อยู่ในข้อมูลที่กำหนด
```
...
```text
ค่า kg ติดลบ แต่ ต้นทางปลายทางตรงกับชุดข้อมูล
```
...
```text
ค่า kg ไม่มีน้ำหนักเลย หรือ kg = 0 แต่แสดงผลค่าธรรมเนียม
```
