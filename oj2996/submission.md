...
```text
โจทย์ให้รับข้อความ 5 อักขระ ตัวท้ายจะเปลี่ยนเป็นตัวอักษรแรก และสลับตำแหน่งเรื่อยๆตามลำดับ
Input:
รับข้อความ 5 อักขระ

Output:
กลับด้านอักษรที่รับมา และแสดงเป็นตัวพิมเล็กเท่านั้น

Constraints:
input ที่รับมาต้องเป็นตัวภาษาอังกฤษ
```
...
```text
Step 1:รับ input และแปลงให้เป็นตัวเล็กทั้งหมด
Step 2:นำค่าที่รับมากลับด้านทั้งหมด
```
...
```text
วิธีสุดท้ายเหมือนกับแผนแรก รับ input และแปลงเป็นตัวเล็กและกลับตัวอักษร
```
...
```text
ต้องแปลงตัวอักษรให้เป็นตัวพิมเล็ก
```
...
```text
หากรับค่ามามีการเว้นวรรค ควรจะตัดตัวเว้นวรรคออก
```
...
```text
จับอักษรพิเศษ อาจเจอบัคได้ในบางครั้ง
```
