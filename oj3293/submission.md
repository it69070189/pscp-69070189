...
```text
Input:
ข้อความจำนวน 5 บรรทัด
Output:
จะใส่กรอบให้ข้อความจำนวน 5 บรรทัด
Constraints:
Input มีแค่ 5 บรรทัด
```
...
```text
หาว่า input บรรทัดไหนยาวที่สุดแล้วค่อยใส่กรอบ
```
...
```text
พอได้ input ที่ยาวที่สุด จึงค่อยเอาไปคำนวนกับช่องว่างที่เหลือ
```
...
```text
หาความยาวสั้นของแต่ละ input เพื่อที่จะสร้างกรอบที่ยาวได้มากที่สุดเท่าไหร่
```
...
```text
ความยาวทุก input เท่ากัน เพื่อที่จะหาว่ามีช่องว่างเกินจำเป็นมั้ย
```
...
```text
ตรวจสอบว่า input ที่มีความยาวที่สุด จะสามารถทำให้กว้างที่สุดได้มั้ย
```
