...
output:
แสดงผลหากตรวจพบสระในข้อมูล ว่ามีกี่ตัว
constraints:
ข้อความยาวได้ไม่เกิน 1000 ตัวและเริ่มต้นที่ 1
```
...
```text
รับข้อความแล้วตรวจว่ามี สระ มั้ย
```
...
```text
แผนเหมือนกับแผนแรก ตรวจว่ามมีสระอยู่มั้ย
```
