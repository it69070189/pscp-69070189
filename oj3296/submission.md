...
```text
input:
จำนวน 2 บรรทัดโดย split 3 ตัว
output:
ค่าเฉลี่ยที่นำมาบวกกันของแต่ละตัวที่ถูก split
constraints:
เป็นจำนวนเต็ม 0-255
```
...
```text
นำ input ที่ split แต่ละตัวมาบวกกันแล้วหารด้วย 2 แบบปัดลง
```
...
```text
ค่าของทั้งสองบวกกันแล้วหารไม่ลงตัว เลยต้องปัดลง
```
...
```text
เลขจำนวนเต็มที่มากที่สุด โดยไม่เกิน 255
```
