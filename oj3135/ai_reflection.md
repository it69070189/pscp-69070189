...
| OJ submission ID, if submitted | 641730 |
| OJ status | Pass |
...
```text
สังเกตว่าควรจะให้ while loop หยุดทำงานตอนไหน เมื่อตรงตามเงื่อนไขที่กำหนด
```
...
```text
ตรวจสอบว่า การคำนวณไปยังคนถัดไปและการตรวจสอบการให้หยุดลูปต้องมีเงื่อนไขเพิ่มเติมหรือไม่
```
...
```text
เรียนรู้การใช้ break เพื่อให้ while loop หยุดทำงานเมื่อทำตามเงื่อนไขที่กำหนด
```
