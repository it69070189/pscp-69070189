...
```text
input:
กรอกเลขจำนวนเต็มบวก N
output:
แสดงค่า N ไปถึง 0 ที่หารด้วย 10 ลงตัว และคั่นด้วยช่องว่าง
constraints:
input ให้กรอกได้แค่จำนวนเต็มบวก
```
...
```text
step1 : รับ input เป็นเลขจำนวนเต็มบวก
step2 : กำหนดช่วงให้ N ลดลงไปเรื่อยๆ ทีละ 10 จนถึง 0 ซึ่งหมายความว่าจะได้ หาร 10 ลงตัว
step3 : แสดงผลค่าที่ออกมาว่าได้ผลหารเท่าไหร่และคูณ 10 เพื่อแยกออกมาว่า N มีตัวไหนหารด้วย 10 ลงตัวบ้าง
...
```text
เหมือนกับวิธีแรกเลย รับค่า N แล้วหักลงไปเรื่อยๆ ทีละ 10 จะได้หาร 10 ลงตัวจนถึง 0 
```
...
```text
หากใช้การหารปกติ / จะได้จุดทศนิยมมาด้วย
```
...
```text
input ที่รับได้เป็นจำนวนเต็มบวกเท่านั้น
```
