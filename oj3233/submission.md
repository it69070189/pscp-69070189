...
```text
โจทย์ให้หารางวัลที่จะได้เยอะที่สุด
Input:
รับค่าที่ผลออกจริง และ ค่าที่เราเลือก
Output:
ถ้าตรงตามเงื่อนไขที่ตั้ง จะได้รางวัลตามเงื่อนไขของแต่ละเงื่อนไข
Constraints:
หมายเลขจะต้องมี 5 หลักเสมอ
```
...
```text
Step1:รับค่าจริง รับค่าที่เราเลือก
Step2:เช็คให้ตรงตามเงื่อนไข
Step3:เช็คว่าตัวอักษรตรงกันมั้ยหรือต่างกัน
Step4:เช็คตัวเลขต่อว่าตรงกันหรือต่างกัน
Step5:แสดงจำนวนเงินรางวัล
```
...
```text
แผนสุดท้ายเหมือนกับแผนแรก โดยเช็คเงื่อนไขให้ระเอียดยิ่งขึ้นโดย ใช้ string slicing เข้าไปในแต่ละหลักเพื่อคำนวณเงินรางวัล
```
...
```text
หลักของค่าจริงและค่าที่เราเลือกไม่ตรงกัน
```
