...
output:
ถ้าหารแล้วได้เศษตรงกับค่าเศษให้แสดงผล
...
```text
แผนแรกวนลูปในช่วงของ input ที่รับมา จาก A ถึง B แล้วก็เอาตัวในแต่ละช่วงหารด้วย input ตัวหาร
หากได้เท่ากับเศษให้ บวกเก็บไปเรื่อยๆ
```
...
```text
แผนสุดท้ายเหมือนกับแผนแรก ถ้าหารแล้วได้เท่ากับเศษที่กำหนดให้บวกค่าเก็บเอาไว้
```
...
```text
วนลูปค่าข้างในว่า หารแล้วได้เศษเท่ากับ r เศษที่ต้องการหรือไม่
```
...
```text
ค่า input B < A และ r > d
จะไม่คำนวนหาก B < A และ r > d เพราะเป็นไปไม่ได้
```
...
```text
ค่า input ติดลบ
จะไม่คำนวนเพราะ input ต้องเป็นจำนวนนับ
```
