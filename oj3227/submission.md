...
โจทย์ให้หาชื่อไพ่
Input:
รับหมายเลขไพ่ หรือ ประเภทไพ่
Output:
แสดงผลตามชื่อไพ่
Constraints:
เลขไม่สามารถเกิน 10 ได้
```
...
```text
Step1:รับ ค่าของไพ่ และตรวจว่ามีเลขหรือไม่และอักษรหรือไม่
Step2:หากอยู่ในเงื่อนไขให้แสดงผล
```
...
```text
ใช้ string slicing เข้ามาแยกตัวเลขและตัวอักษร โดยไม่ต้องใช้ if แล้ว จากนั้นสร้าง dic หากตรงให้คืนค่าออกมาตามที่โจทย์ต้องการ
```
