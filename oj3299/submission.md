...
```text
input:
รับขนาดของแถบ และ ปลูกไปกี่ช่อง
output:
ช่องสุดท้ายอยู่ที่แถบที่เท่าไหร่ของการกระจาย
constraints:
1 <= ขนาด <= 10 , 1 <= ช่อง <= 100,000 และไม่สามารถเป็น 0 ได้ทั้ง 2 input
```
...
```text
คำนวณหาก้อนแรกโดยเอาแถบได้ไป -1 เรื่อยๆจนมีค่า = 0 และนำไปบวกกันเพื่อเก็บผลรวมของแถบแรกที่ปลูกไป
จากนั้นก็เอาไปรวมกับก้อนถัดไปโดยจับ pattern ได้ดังนี้ ผลรวมก้อนแรก + (แถบ * แถบ) แล้วก็วนซ้ำเก็บไปเรื่อยๆจนกว่าผลรวมของช่องจทั้งหมดที่สามารถปลูกได้จะมากกว่า input ช่องที่เราปลูก จึงหยุดนับแถบ
...
```text
วิธีสุดท้ายเหมือนกันกับวิธีแรก แต่เพิ่มเงื่อนไขโดยการเช็คว่า ถ้าหากช่องของผลรวมทั้งหมดที่สามารถปลูกได้ เท่ากันกับช่องที่เราปลูกจะเป็นยังไง
```
...
```text
ถ้าเกิดว่าไม่ปลูกเลยก็จะได้ไม่ได้สักแถบ
```
...
```text
ถ้าเกิดว่าขนาดของช่อง = 0 แสดงว่าเราก็ไม่ได้ปลูกอยู่ดี
```
...
```text
ถ้าหากว่าขนาดของแถบติดลบ แสดงว่าเราก็ยังไม่ได้ปลูก
```
