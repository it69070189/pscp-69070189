...
```text
input:
รับค่าอุณหภูมิ ของหน่วยอุณหภูมินั้นๆ และต้องการเป็นหน่วยใด
```
...
```text
Step 1: รับองศา
Step 2: หาสูตรแปลงค่าที่นอกเหนือจากที่โจทย์บอก
Step 3: เช็คว่าต้องการแปลงจาก หน่วยใดเป็นหน่วยใด

ก่อนถามเพื่อน ฉันไม่แน่ใจว่าจำเป็นต้องหาสูตรนอกเหนือจากที่โจทย์บอกหรือไม่
```
...
```text
วิธีสุดท้ายของฉัน รับค่าอุณหภูมิโดยแปลงค่านี้เป็นค่าเริ่มต้นนั่นก็คือ Celcius แล้วนำไปคำนวณในสูตร ซึ่งหลังจากถามเพื่อนแล้วไม่จำเป็นต้องหาสูตรเพิ่ม แค่สลับตัวแปรสลับสมการ ก็จะสามารถแปลงค่าจากหน่วยต่างๆกลับมาเป็น Celcius ได้ หลังจากนั้นเอา Celcius ที่ได้ไปใช้กับสูตรที่โจทย์บอกในการแปลงเป็นหน่วยต่างๆที่เราต้องการ และหลังจากนั้นทำการเช็คว่าต้องการแปลงเป็นหน่วยใด 
```
...
```text
input ที่รับเป็นตัวพิมเล็ก จึงไม่เข้าเงื่อนไขใดๆและแสดงค่าว่าง
```
...
```text
หน่วยที่ต้องการแปลงไม่ได้อยู่ใน C F R K ไม่เข้าเงื่อนไขใดๆและแสดงค่าว่างออกมา
```
...
```text
หน่วยที่ต้องการแปลงเป็นหน่วยเดิม
```
...
```text
อธิบายแนวคิดที่ง่ายทำให้เรื่องที่ซับซ้อนกลายเป็นง่าย
```
