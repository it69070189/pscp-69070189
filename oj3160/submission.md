...
รับ start , stop
output:
แสดงค่าที่เป็นจำนวนเฉพาะ
constraints:
จะคำนวณค่าที่เป็นจำนวนเต็มบวกเท่านั้น
```
...
```text
Step 1: กำหนดช่วงให้ loop
Step 2: กำหนดช่วงให้ เอาไปหาร loop 
Step 3:กำหนด ลิสว่าง
Step 4:กำหนด count และนับจำนวนครั้งที่ผ่านลูป ที่ผ่านเงื่อนไข
Step 5:เข้าถึงลิสที่สร้างเอาไว้แล้วแสดงผลทีละตัว
```
...
```text
เหมือนกับวิธีแรกแต่เพิ่มขั้นตอนในการ ออกนอก loop โดยการกำหนดเงื่อนไขดังนี้ ถ้า ลูปแรก และลูปสอง โดยที่ ลูปแรกหารโดยลูปสอง ยังเท่ากับตัวมันเองแสดงว่าหารไม่ลงตัว ให้เพิ่มเข้าไปในลิส และหยุดลูปด้วยการ หากลูปแรกหารด้วยลูปสองแล้วลงตัวแสดงว่าจะไม่ใช่จำนวนเฉพาะให้หยุดลูป 
```
...
```text
หากค่าเป็นจำนวนติดลบยังคงแสดงผล
```
...
```text
หาก input เป็นจำนวนเต็มศูนย์ยังคงแสดงผล
```
...
```text
หากให้กรอก input ไม่ครบ 2 argument จะ valueerror
```
